...
$BLOCK B_{name}_adjCost
	...
	E_{name}_pK[t,tech]$(dTech[t,tech] and tx02E[t])..			pKEOP[t,tech]		=E= sqrt(sqr(Rrate[t]*(1+adjCostParEOP[tech]*( (qIEOP[t-1,tech]+qKmin[t-1,tech]*(rDeprEOP[tech]+g_LR))/(qKEOP[t-1,tech]+qKmin[t-1,tech])-(rDeprEOP[tech]+g_LR)))/(1+infl_LR)+adjCostParEOP[tech]*0.5*(sqr(rDeprEOP[tech]+g_LR)-sqr((qIEOP[t,tech]+qKmin[t,tech]*(rDeprEOP[tech]+g_LR))/(qKEOP[t,tech]+qKmin[t,tech])))-(1-rDeprEOP[tech])*(1+adjCostParEOP[tech]*((qIEOP[t,tech]+qKmin[t,tech]*(rDeprEOP[tech]+g_LR))/(qKEOP[t,tech]+qKmin[t,tech])-(rDeprEOP[tech]+g_LR))))); # Tobin's Q for abatement capital
...
EOP_PriceIte = f"""
pKEOP.l[t,tech]$(dTech[t,tech] and t2E[t])	= sqrt(sqr(Rrate.l[t]*(1+adjCostParEOP.l[tech]*( (qIEOP.l[t-1,tech]+qKmin.l[t-1,tech]*(rDeprEOP.l[tech]+g_LR))/(qKEOP.l[t-1,tech]+qKmin.l[t-1,tech])-(rDeprEOP.l[tech]+g_LR)))/(1+infl_LR)+rDeprEOP.l[tech]-1));
pKEOP.l[t,tech]$(dTech[t,tech] and tx02E[t])= sqrt(sqr(Rrate.l[t]*(1+adjCostParEOP.l[tech]*( (qIEOP.l[t-1,tech]+qKmin.l[t-1,tech]*(rDeprEOP.l[tech]+g_LR))/(qKEOP.l[t-1,tech]+qKmin.l[t-1,tech])-(rDeprEOP.l[tech]+g_LR)))/(1+infl_LR)+adjCostParEOP.l[tech]*0.5*(sqr(rDeprEOP.l[tech]+g_LR)-sqr((qIEOP.l[t,tech]+qKmin.l[t,tech]*(rDeprEOP.l[tech]+g_LR))/(qKEOP.l[t,tech]+qKmin.l[t,tech])))-(1-rDeprEOP.l[tech])*(1+adjCostParEOP.l[tech]*((qIEOP.l[t,tech]+qKmin.l[t,tech]*(rDeprEOP.l[tech]+g_LR))/(qKEOP.l[t,tech]+qKmin.l[t,tech])-(rDeprEOP.l[tech]+g_LR)))));
pKEOP.l[t,tech]$(dTech[t,tech] and t0[t])	= sqrt(sqr(Rrate.l[t]+adjCostParEOP.l[tech]*0.5*(sqr(rDeprEOP.l[tech]+g_LR)-sqr((qIEOP.l[t,tech]+qKmin.l[t,tech]*(rDeprEOP.l[tech]+g_LR))/(qKEOP.l[t,tech]+qKmin.l[t,tech])))-(1-rDeprEOP.l[tech])*(1+adjCostParEOP.l[tech]*((qIEOP.l[t,tech]+qKmin.l[t,tech]*(rDeprEOP.l[tech]+g_LR))/(qKEOP.l[t,tech]+qKmin.l[t,tech])-(rDeprEOP.l[tech]+g_LR)))));

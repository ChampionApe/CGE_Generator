...
def priceBlock(name, m, addInc_tx0 = '', addInc_t0 = '', addMargCostInp = ''):
	return f"""
$BLOCK B_{name}
	E_{name}_pD[t,s,n]$({m}_input[s,n] and txE[t])..	pD[t,s,n]		=E= p[t,n]*(1+tauD[t,s,n]){addMargCostInp}; # effective input prices

...
E_P_pWedge_pwOut[t,s,n]$(p_output[s,n] and txe[t]).. 				p[t,n] 			 =E=  (1+markup[s])*(pS[t,s,n]+(tauEffCO2[t,s,n]*uCO2[t,s,n])$(dqCO2[s,n])+tauS[t,s,n]+(adjCost[t,s]+tauLump[t,s])/qS[t,s,n]);
...
E_uAbate[t,s,n]$(dqco2[s,n] and txe[t]).. 		uAbate[t,s,n]		 =E=  sum(tech, techPot[tech,t] * 
 ...
 EOP_Normal( (tauCO2[t,s,n]), (techCost[tech,t]), (techSmooth[tech]) ) 
...
E_tauCO2Eff[t,s,n]$(dtauco2[s,n] and txe[t]).. 	tauEffCO2[t,s,n]	 =E=  tauCO2[t,s,n]*(1-uAbate[t,s,n])+sum(tech, techPot[tech,t] * 
 ...
 EOP_NormalCost( (tauCO2[t,s,n]), (techCost[tech,t]), (techSmooth[tech]) ) 
...
E_qCO2agg[t]$(txe[t]).. 							qCO2agg[t]			 =E=  sum([s,n]$(dqCO2[s,n]), qCO2[t,s,n])-qCO2Base * 
 ...
 EOP_Normal( (tauCO2agg[t]), (DACCost[t]), (DACSmooth) ) 
...
# @SolveEmptyNLP(M_vLarge_2019_CGE_B_SYT_HR);
solve M_vLarge_2019_CGE_B_SYT_HR using CNS;

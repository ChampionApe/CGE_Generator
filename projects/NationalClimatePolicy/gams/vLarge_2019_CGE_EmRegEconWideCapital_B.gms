...
qK_EOP.l[t] = 1e6*(sum([s,n]$(dqCO2[s,n]), uCO2.l[t,s,n]*qS.l[t,s,n]*sum(tech, techPot.l[tech,t]*
# ----------------------------------------------------------------------------------------------------
#  IF 'normalMult' == 'normal':
# ----------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------
#  IF 'normalMult' == 'normalMult':
# ----------------------------------------------------------------------------------------------------
 EOP_NormalMultCost( (tauCO2.l[t,s,n]), (techCost.l[tech,t]*pK_EOP.l[t]/[R_LR-1+rDepr_EOP.l]), (techSmooth.l[tech,t]) ) 
# ----------------------------------------------------------------------------------------------------
#  ENDIF
# ----------------------------------------------------------------------------------------------------
...
# --------------------------------------------B_M_SYT_Calib-------------------------------------------
#  Initialize B_M_SYT_Calib equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_SYT_qCO2agg[t];
E_SYT_qCO2agg[t]$(t_syt[t] and tx0e[t])..  	qCO2agg[t]		 =E=  qCO2_SYT[t];
EQUATION E_SYT_tauCO2agg[t];
E_SYT_tauCO2agg[t]$(t_syt_nb[t]).. 			tauCO2agg[t]	 =E=  0;

# ----------------------------------------------------------------------------------------------------
#  Define B_M_SYT_Calib model
# ----------------------------------------------------------------------------------------------------
Model B_M_SYT_Calib /
E_SYT_qCO2agg, E_SYT_tauCO2agg
/;


# ---------------------------------------------B_M_SYT_t0---------------------------------------------
#  Initialize B_M_SYT_t0 equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_SYT_t0[t];
E_SYT_t0[t]$(t_syt[t] and t0[t]).. 	qCO2agg[t]	 =E=  qCO2_SYT[t];

# ----------------------------------------------------------------------------------------------------
#  Define B_M_SYT_t0 model
# ----------------------------------------------------------------------------------------------------
Model B_M_SYT_t0 /
E_SYT_t0
/;
...
# ----------------------------------------------------------------------------------------------------
#  Define B_M_SYT model
# ----------------------------------------------------------------------------------------------------
Model B_M_SYT /
E_SYT_qCO2agg, E_SYT_tauCO2agg, E_SYT_t0
/;



# ------------------------------------------B_M_SYT_HR_Calib------------------------------------------
#  Initialize B_M_SYT_HR_Calib equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_SYT_HR_qCO2agg[t];
E_SYT_HR_qCO2agg[t]$(t_syt[t] and tx0e[t]).. 	 	qCO2agg[t]		 =E=  qCO2_SYT[t];
EQUATION E_SYT_HR_tauCO2agg[t];
E_SYT_HR_tauCO2agg[t]$(t_syt_nb[t]).. 				tauCO2agg[t]	 =E=  tauCO2agg[t+1]/Rrate[t];

# ----------------------------------------------------------------------------------------------------
#  Define B_M_SYT_HR_Calib model
# ----------------------------------------------------------------------------------------------------
Model B_M_SYT_HR_Calib /
E_SYT_HR_qCO2agg, E_SYT_HR_tauCO2agg
/;


# ----------------------------------------------------------------------------------------------------
#  Define B_M_SYT_HR model
# ----------------------------------------------------------------------------------------------------
Model B_M_SYT_HR /
E_SYT_HR_qCO2agg, E_SYT_HR_tauCO2agg, E_SYT_t0
/;



# ------------------------------------------B_M_SYT_OPT_Calib-----------------------------------------
#  Initialize B_M_SYT_OPT_Calib equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_SYT_OPT_qCO2agg[t];
E_SYT_OPT_qCO2agg[t]$(t_syt[t] and tx0e[t])..  	qCO2agg[t]		 =E=  qCO2_SYT[t];
EQUATION E_SYT_OPT_obj;
E_SYT_OPT_obj.. 									obj  =E=  sum([t,s]$(t0[t] and s_HH[s]), discUtil[t,s]);

# ----------------------------------------------------------------------------------------------------
#  Define B_M_SYT_OPT_Calib model
# ----------------------------------------------------------------------------------------------------
Model B_M_SYT_OPT_Calib /
E_SYT_OPT_qCO2agg, E_SYT_OPT_obj
/;


# ----------------------------------------------------------------------------------------------------
#  Define B_M_SYT_OPT model
# ----------------------------------------------------------------------------------------------------
Model B_M_SYT_OPT /
E_SYT_OPT_qCO2agg, E_SYT_OPT_obj, E_SYT_t0
/;



# --------------------------------------------B_M_LRP_Calib-------------------------------------------
#  Initialize B_M_LRP_Calib equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_LRP_qCO2agg[t];
E_LRP_qCO2agg[t]$(t_lrp[t] and tx0e[t])..  		qCO2agg[t]		 =E=  qCO2_LRP[t];

# ----------------------------------------------------------------------------------------------------
#  Define B_M_LRP_Calib model
# ----------------------------------------------------------------------------------------------------
Model B_M_LRP_Calib /
E_LRP_qCO2agg
/;
...
# ---------------------------------------------B_M_LRP_t0---------------------------------------------
#  Initialize B_M_LRP_t0 equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_LRP_t0[t];
E_LRP_t0[t]$(t_lrp[t] and t0[t]).. 	qCO2agg[t]	 =E=  qCO2_LRP[t];

# ----------------------------------------------------------------------------------------------------
#  Define B_M_LRP_t0 model
# ----------------------------------------------------------------------------------------------------
Model B_M_LRP_t0 /
E_LRP_t0
/;
...
# ----------------------------------------------------------------------------------------------------
#  Define B_M_LRP model
# ----------------------------------------------------------------------------------------------------
Model B_M_LRP /
E_LRP_qCO2agg, E_LRP_t0
/;



# -------------------------------------------B_M_EB_HR_Calib------------------------------------------
#  Initialize B_M_EB_HR_Calib equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_EB_HR_qCO2agg[t];
E_EB_HR_qCO2agg[t]$(t_eb[t] and tx0e[t])..  		qCO2_EB[t]		 =E=  sum(tt$(t2tt_EB[t, tt]), qCO2agg[tt]);
EQUATION E_EB_HR_SYT_qCO2agg[t];
E_EB_HR_SYT_qCO2agg[t]$(t_eb_syt[t]).. 			qCO2agg[t]		 =E=  qCO2_EB_SYT[t];
EQUATION E_EB_HR_tauCO2agg[t];
E_EB_HR_tauCO2agg[t]$(t_eb_nb[t]).. 				tauCO2agg[t]	 =E=  tauCO2agg[t+1]/Rrate[t];

# ----------------------------------------------------------------------------------------------------
#  Define B_M_EB_HR_Calib model
# ----------------------------------------------------------------------------------------------------
Model B_M_EB_HR_Calib /
E_EB_HR_qCO2agg, E_EB_HR_SYT_qCO2agg, E_EB_HR_tauCO2agg
/;


# ----------------------------------------------B_M_EB_t0---------------------------------------------
#  Initialize B_M_EB_t0 equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_EB_t0[t];
E_EB_t0[t]$(t_eb[t] and t0[t]).. 	qCO2_EB[t]		 =E=  sum(tt$(t2tt_EB[t, tt]), qCO2agg[tt]);

# ----------------------------------------------------------------------------------------------------
#  Define B_M_EB_t0 model
# ----------------------------------------------------------------------------------------------------
Model B_M_EB_t0 /
E_EB_t0
/;
...
# ----------------------------------------------------------------------------------------------------
#  Define B_M_EB_HR model
# ----------------------------------------------------------------------------------------------------
Model B_M_EB_HR /
E_EB_HR_qCO2agg, E_EB_HR_SYT_qCO2agg, E_EB_HR_tauCO2agg, E_EB_t0
/;
	


# ------------------------------------------B_M_EB_OPT_Calib------------------------------------------
#  Initialize B_M_EB_OPT_Calib equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_EB_OPT_qCO2agg[t];
E_EB_OPT_qCO2agg[t]$(t_eb[t] and tx0e[t])..  	qCO2_EB[t]	 =E=  sum(tt$(t2tt_EB[t, tt]), qCO2agg[tt]);
EQUATION E_EB_OPT_SYT_qCO2agg[t];
E_EB_OPT_SYT_qCO2agg[t]$(t_eb_syt[t]).. 			qCO2agg[t]	 =E=  qCO2_EB_SYT[t];
EQUATION E_EB_OPT_obj;
E_EB_OPT_obj.. 									obj  =E=  sum([t,s]$(t0[t] and s_HH[s]), discUtil[t,s]);

# ----------------------------------------------------------------------------------------------------
#  Define B_M_EB_OPT_Calib model
# ----------------------------------------------------------------------------------------------------
Model B_M_EB_OPT_Calib /
E_EB_OPT_qCO2agg, E_EB_OPT_SYT_qCO2agg, E_EB_OPT_obj
/;


# ----------------------------------------------------------------------------------------------------
#  Define B_M_EB_OPT model
# ----------------------------------------------------------------------------------------------------
Model B_M_EB_OPT /
E_EB_OPT_qCO2agg, E_EB_OPT_SYT_qCO2agg, E_EB_OPT_obj, E_EB_t0
/;
...
# ----------------------------------------------------------------------------------------------------
#  Define M_vLarge_2019_CGE_EmRegEconWideCapital_B_SYT_HR model
# ----------------------------------------------------------------------------------------------------
Model M_vLarge_2019_CGE_EmRegEconWideCapital_B_SYT_HR /
E_P_zpOut, E_P_zpNOut, E_P_qOut, E_P_qNOut, E_P_adjCost_lom, E_P_adjCost_pk, E_P_adjCost_pkT, E_P_adjCost_K_tvc, E_P_adjCost_adjCost, E_P_pWedge_pwInp, E_P_pWedge_pwOut, E_P_pWedge_taxRev, E_I_zpOut, E_I_zpNOut, E_I_qOut, E_I_qNOut, E_I_adjCost_lom, E_I_adjCost_pk, E_I_adjCost_pkT, E_I_adjCost_K_tvc, E_I_adjCost_adjCost, E_I_pWedge_pwInp, E_I_pWedge_pwOut, E_I_pWedge_taxRev, E_HH_zp, E_HH_q, E_HH_CRRA_GHH_qC, E_HH_CRRA_GHH_V, E_HH_CRRA_GHH_VT, E_HH_CRRA_GHH_L, E_HH_pWedge_pwOut, E_HH_pWedge_pwInp, E_HH_pWedge_TaxRev, E_HH_pWedge_sp, E_HH_euler_lom, E_HH_euler_euler, E_HH_euler_tvc, E_G_zp, E_G_q, E_G_bb_pw, E_G_bb_taxRev, E_G_bb_bb, E_G_taxCalib_taxCal, E_Itory, E_T_armington, E_T_pwInp, E_T_TaxRev, E_uAbate, E_tauCO2Eff, E_tauCO2, E_qCO2, E_qCO2agg, E_M_lom, E_M_pk, E_M_pKT, E_M_Ktvc, E_M_adjCost, E_M_equi, E_SYT_HR_qCO2agg, E_SYT_HR_tauCO2agg, E_SYT_t0, E_Equi_equi
/;


# ----------------------------------------------------------------------------------------------------
#  Define M_vLarge_2019_CGE_EmRegEconWideCapital_C_SYT_HR model
# ----------------------------------------------------------------------------------------------------
Model M_vLarge_2019_CGE_EmRegEconWideCapital_C_SYT_HR /
E_P_zpOut, E_P_zpNOut, E_P_qOut, E_P_qNOut, E_P_adjCost_lom, E_P_adjCost_pk, E_P_adjCost_pkT, E_P_adjCost_K_tvc, E_P_adjCost_adjCost, E_P_pWedge_pwInp, E_P_pWedge_pwOut, E_P_pWedge_taxRev, E_P_taxCalib_taxCal, E_I_zpOut, E_I_zpNOut, E_I_qOut, E_I_qNOut, E_I_adjCost_lom, E_I_adjCost_pk, E_I_adjCost_pkT, E_I_adjCost_K_tvc, E_I_adjCost_adjCost, E_I_pWedge_pwInp, E_I_pWedge_pwOut, E_I_pWedge_taxRev, E_I_taxCalib_taxCal, E_HH_zp, E_HH_q, E_HH_CRRA_GHH_qC, E_HH_CRRA_GHH_V, E_HH_CRRA_GHH_VT, E_HH_CRRA_GHH_L, E_HH_pWedge_pwOut, E_HH_pWedge_pwInp, E_HH_pWedge_TaxRev, E_HH_pWedge_sp, E_HH_euler_lom, E_HH_euler_euler, E_HH_euler_tvc, E_G_zp, E_G_q, E_G_bb_pw, E_G_bb_taxRev, E_G_bb_bb, E_G_taxCalib_taxCal, E_Itory, E_T_armington, E_T_pwInp, E_T_TaxRev, E_uAbate, E_tauCO2Eff, E_tauCO2, E_qCO2, E_qCO2agg, E_M_lom, E_M_pk, E_M_pKT, E_M_Ktvc, E_M_adjCost, E_M_equi, E_SYT_HR_qCO2agg, E_SYT_HR_tauCO2agg, E_SYT_t0, E_qCO2calib, E_qK_EOPt0, E_Equi_equi_tx0E
/;
...
jTerm.fx[s]$(I_sm[s]) = jTerm.l[s]$(I_sm[s]);
...
tauCO2agg.lo[t]$(((t_SYT[t] or t_SYT_NB[t]) or (t0[t] and t_SYT[t]))) = -inf;
tauCO2agg.up[t]$(((t_SYT[t] or t_SYT_NB[t]) or (t0[t] and t_SYT[t]))) = inf;
obj.lo = -inf;
obj.up = inf;
...
# @SolveEmptyNLP(M_vLarge_2019_CGE_EmRegEconWideCapital_B_SYT_HR);
solve M_vLarge_2019_CGE_EmRegEconWideCapital_B_SYT_HR using CNS;

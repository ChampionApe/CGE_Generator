...
$MACRO EOP_NormalCost(p, c, e) EOP_Normal(p, c, e)*c-e*stdNormPdf((c-p)/e)
...
E_P_taxCalib_taxCal[t,s,n]$(p_output[s,n] and txe[t]).. 	tauS[t,s,n]	 =E=  tauS0[t,s,n] * (1+taxRevPar[s]);
...
E_I_taxCalib_taxCal[t,s,n]$(i_output[s,n] and txe[t]).. 	tauS[t,s,n]	 =E=  tauS0[t,s,n] * (1+taxRevPar[s]);
...
# @SolveEmptyNLP(M_vTest_2019_CGE_C);
solve M_vTest_2019_CGE_C using CNS;;

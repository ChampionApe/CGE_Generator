...
# ----------------------------------------------B_O_price---------------------------------------------
#  Initialize B_O_price equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_O_price_pD[t,s,n];
E_O_price_pD[t,s,n]$(o_input[s,n] and txe[t]).. 			pD[t,s,n]		 =E=  p[t,n]*(1+tauD[t,s,n]);
EQUATION E_O_price_pS[t,s,n];
...
EQUATION E_O_price_TotalTax[t,s];
...
# ----------------------------------------------------------------------------------------------------
#  Define B_O_price model
# ----------------------------------------------------------------------------------------------------
Model B_O_price /
E_O_price_pD, E_O_price_pS, E_O_price_TotalTax
/;
...
# ----------------------------------------------------------------------------------------------------
EQUATION E_O_taxCalib_taxRevPar[t,s];
...
# ----------------------------------------------------------------------------------------------------
#  Define M_WasteCGE_CGE_B model
# ----------------------------------------------------------------------------------------------------
Model M_WasteCGE_CGE_B /
E_O_zpOut, E_O_zpNOut, E_O_qOut, E_O_qNOut, E_O_price_pD, E_O_price_pS, E_O_price_TotalTax, E_O_firmValue_vA, E_O_firmValue_divd, E_O_firmValue_vAT, E_O_adjCost_lom, E_O_adjCost_pk, E_O_adjCost_pkT, E_O_adjCost_K_tvc, E_O_adjCost_adjCost, E_W_zpOut, E_W_zpNOut, E_W_qOut, E_W_qNOut, E_WE_zpOut, E_WE_zpNOut, E_WE_qOut, E_WE_qNOut, E_W_price_pD, E_W_price_pS, E_W_price_TotalTax, E_W_firmValue_vA, E_W_firmValue_divd, E_W_firmValue_vAT, E_W_adjCost_lom, E_W_adjCost_pk, E_W_adjCost_pkT, E_W_adjCost_K_tvc, E_W_adjCost_adjCost, E_I_zpOut, E_I_zpNOut, E_I_qOut, E_I_qNOut, E_I_price_pD, E_I_price_pS, E_I_price_TotalTax, E_I_firmValue_vA, E_I_firmValue_divd, E_I_firmValue_vAT, E_HH_zp, E_HH_q, E_HH_price_pD, E_HH_price_w, E_HH_price_TotalTax, E_HH_price_vA0, E_HH_price_vA, E_HH_vU_vU, E_HH_vU_vUT, E_G_zp, E_G_q, E_G_price_pD, E_G_price_TotalTax, E_G_price_vA0, E_G_price_vA, E_T_qD, E_T_pD, E_T_TotalTax, E_IVT, E_M_tauCO2, E_M_tauCO2Eff, E_M_qCO2, E_M_qCO2agg, E_Equi_equi
/;


# ----------------------------------------------------------------------------------------------------
#  Define M_WasteCGE_CGE_C model
# ----------------------------------------------------------------------------------------------------
Model M_WasteCGE_CGE_C /
E_O_zpOut, E_O_zpNOut, E_O_qOut, E_O_qNOut, E_O_price_pD, E_O_price_pS, E_O_price_TotalTax, E_O_firmValue_vA, E_O_firmValue_divd, E_O_firmValue_vAT, E_O_adjCost_lom, E_O_adjCost_pk, E_O_adjCost_pkT, E_O_adjCost_K_tvc, E_O_adjCost_adjCost, E_O_taxCalib_taxRevPar, E_W_zpOut, E_W_zpNOut, E_W_qOut, E_W_qNOut, E_WE_zpOut, E_WE_zpNOut, E_WE_qOut, E_WE_qNOut, E_W_price_pD, E_W_price_pS, E_W_price_TotalTax, E_W_firmValue_vA, E_W_firmValue_divd, E_W_firmValue_vAT, E_W_adjCost_lom, E_W_adjCost_pk, E_W_adjCost_pkT, E_W_adjCost_K_tvc, E_W_adjCost_adjCost, E_W_taxCalib_taxRevPar, E_I_zpOut, E_I_zpNOut, E_I_qOut, E_I_qNOut, E_I_price_pD, E_I_price_pS, E_I_price_TotalTax, E_I_firmValue_vA, E_I_firmValue_divd, E_I_firmValue_vAT, E_I_taxCalib_taxRevPar, E_HH_zp, E_HH_q, E_HH_price_pD, E_HH_price_w, E_HH_price_TotalTax, E_HH_price_vA0, E_HH_price_vA, E_HH_vU_vU, E_HH_vU_vUT, E_HH_taxCalib_taxRevPar, E_G_zp, E_G_q, E_G_price_pD, E_G_price_TotalTax, E_G_price_vA0, E_G_price_vA, E_G_taxCalib_taxRevPar, E_T_qD, E_T_pD, E_T_TotalTax, E_IVT, E_M_tauCO2, E_M_tauCO2Eff, E_M_qCO2, E_M_qCO2agg, E_M_qCO2calib, E_Equi_equi_tx0E
/;
;
...
# solve:
 solve M_WasteCGE_CGE_B using CNS;

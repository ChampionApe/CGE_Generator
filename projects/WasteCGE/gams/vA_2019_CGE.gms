...
# WRITE INIT STATEMENTS FROM MODULES:
	...
	divd.l[t,s]$(P_sm[s] and txE[t]) = sum(n$(P_output[s,n]), p.l[t,n] * qS.l[t,s,n])-sum(n$(P_input[s,n]), p.l[t,n]*qD.l[t,s,n])-TotalTax.l[t,s];
	vA.l[t,s]$(P_sm[s] and txE[t]) = divd.l[t,s]/(R_LR-1);
	vA.l[t,s]$(P_sm[s] and tE[t])	= divd.l[t-1,s]/(R_LR-1);
...
E_P_pWedge_pwInp[t,s,n]$(p_input[s,n] and txe[t]).. 			pD[t,s,n]		 =E=  p[t,n]*(1+tauD[t,s,n]);
EQUATION E_P_pWedge_pwOut[t,s,n];
E_P_pWedge_pwOut[t,s,n]$(p_output[s,n] and txe[t]).. 		p[t,n] 			 =E=  (1+markup[s])*(pS[t,s,n]+p[t,n]*tauS[t,s,n]+(tauEffCO2[t,s,n]*uCO2[t,s,n])$(dqCO2[s,n]));
EQUATION E_P_pWedge_taxRev[t,s];
E_P_pWedge_taxRev[t,s]$(p_sm[s] and txe[t]).. 				TotalTax[t,s]	 =E=  tauLump[t,s]+sum(n$(P_input[s,n]), tauD[t,s,n] * p[t,n] * qD[t,s,n])+sum(n$(P_output[s,n]), tauS[t,s,n]*p[t,n]*qS[t,s,n])+sum(n$(P_output[s,n] and dqCO2[s,n]), tauCO2[t,s,n]*qCO2[t,s,n]);
...
E_P_firmValue_vAT[t,s]$(p_sm[s] and te[t]).. 		vA[t,s]	   =E=  (1+vA_tvc[s])*vA[t-1,s];
...
E_W_zpOut, E_W_zpNOut, E_W_qOut, E_W_qNOut, E_O_zpOut, E_O_zpNOut, E_O_qOut, E_O_qNOut, E_P_pWedge_pwInp, E_P_pWedge_pwOut, E_P_pWedge_taxRev, E_P_firmValue_vA, E_P_firmValue_divd, E_P_firmValue_vAT, E_P_adjCost_lom, E_P_adjCost_pk, E_P_adjCost_pkT, E_P_adjCost_K_tvc, E_P_adjCost_adjCost, E_I_zpOut, E_I_zpNOut, E_I_qOut, E_I_qNOut, E_I_pWedge_pwInp, E_I_pWedge_pwOut, E_I_pWedge_taxRev, E_HH_zp, E_HH_q, E_HH_pWedge_pwOut, E_HH_pWedge_pwInp, E_HH_pWedge_TaxRev, E_HH_pWedge_sp, E_HH_vU_qC, E_HH_vU_V, E_HH_vU_VT, E_HH_vU_L, E_G_zp, E_G_q, E_G_bb_pw, E_G_bb_taxRev, E_G_bb_bb, E_G_taxCalib_taxCal, E_Itory, E_T_armington, E_T_pwInp, E_T_TaxRev, E_uAbate, E_avgAbateCost, E_abateCosts, E_tauCO2Eff, E_tauCO2, E_qCO2, E_qCO2agg, E_Equi_equi
/;
...
E_W_zpOut, E_W_zpNOut, E_W_qOut, E_W_qNOut, E_O_zpOut, E_O_zpNOut, E_O_qOut, E_O_qNOut, E_P_pWedge_pwInp, E_P_pWedge_pwOut, E_P_pWedge_taxRev, E_P_firmValue_vA, E_P_firmValue_divd, E_P_firmValue_vAT, E_P_adjCost_lom, E_P_adjCost_pk, E_P_adjCost_pkT, E_P_adjCost_K_tvc, E_P_adjCost_adjCost, E_P_taxCalib_taxCal, E_I_zpOut, E_I_zpNOut, E_I_qOut, E_I_qNOut, E_I_pWedge_pwInp, E_I_pWedge_pwOut, E_I_pWedge_taxRev, E_I_taxCalib_taxCal, E_HH_zp, E_HH_q, E_HH_pWedge_pwOut, E_HH_pWedge_pwInp, E_HH_pWedge_TaxRev, E_HH_pWedge_sp, E_HH_vU_qC, E_HH_vU_V, E_HH_vU_VT, E_HH_vU_L, E_G_zp, E_G_q, E_G_bb_pw, E_G_bb_taxRev, E_G_bb_bb, E_G_taxCalib_taxCal, E_Itory, E_T_armington, E_T_pwInp, E_T_TaxRev, E_uAbate, E_avgAbateCost, E_abateCosts, E_tauCO2Eff, E_tauCO2, E_qCO2, E_qCO2agg, E_qCO2calib, E_Equi_equi_tx0E
/;
;

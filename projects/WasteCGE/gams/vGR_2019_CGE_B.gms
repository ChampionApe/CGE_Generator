...
tauNonEnv.fx[t,s,n]$(W_output[s,n]) = tauNonEnv.l[t,s,n]$(W_output[s,n]);
...
Rrate.fx[t] = Rrate.l[t];
tauNonEnv.fx[t,s,n]$(O_output[s,n]) = tauNonEnv.l[t,s,n]$(O_output[s,n]);
...
tauS.lo[t,s,n]$(((G_L[s,n] and tx0E[t]) or (G_L[s,n] and t0[t]))) = -inf;
tauS.up[t,s,n]$(((G_L[s,n] and tx0E[t]) or (G_L[s,n] and t0[t]))) = inf;
...
# @SolveEmptyNLP(M_vGR_2019_CGE_B);

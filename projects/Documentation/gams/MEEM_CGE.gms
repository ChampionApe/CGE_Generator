...
# ------------------------------------------------B_Out-----------------------------------------------
#  Initialize B_Out equation block
# ----------------------------------------------------------------------------------------------------
EQUATION E_Out_zp[t,s,n];
...
EQUATION E_Out_demand_out[t,s,n];
...
EQUATION E_Out_demand_nout[t,s,n];
...
# ----------------------------------------------------------------------------------------------------
Model B_Out /
E_Out_zp, E_Out_demand_out, E_Out_demand_nout
/;
